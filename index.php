                  ...
                  <div class="container" id="contact">
                        ...
                        <div class="row">
                          <div class="col-sm-5">
                            ...
                            <p><span class="glyphicon glyphicon-phone"></span> +91 8073827984</p>
                          ...
                          <form method="post" action="index.php">
                            ...
                            <div class="row">
                              <div class="col-sm-12 form-group">
                                <button class="btn btn-default pull-right" name="submit1" type="submit">Send</button>
                              </div>
                            </div>
                        </div>
                          </form>
