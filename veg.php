...
<body>
        <nav class="navbar navbar-inverse navbar-fixed-top">
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                      <li class="active"><a href="veg.php">Veg</a></li>
          ...
          else
          {
            ...
            <div class="rows">
              <?php 
                    $result = mysqli_query($conn,"SELECT * FROM foods where catagory = 'veg'");
                    ...
                    <form method="post" action="cart.php">
                        <input type="hidden" name="code" value="'.$row['code'].'" />
                          <div class="thumbnail">
                                  <img class="img" src="'.$row['image'].'" alt="Veg Food">
                ...
                <?php
                // echo implode(" ",array_keys($_SESSION['shopping_cart']));
